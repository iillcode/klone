/* SVG icons for the layers sidebar (Figma-style layer tree). */

import type { SVGProps } from "react";

/* Grid icon – closed state (outlined) */
export function GridClosedIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function GridOpenIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      className="w-3 h-3 shrink-0"
      fill="currentColor"
...
export function RectIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className ?? "w-3.5 h-3.5"}
      fill="none"
