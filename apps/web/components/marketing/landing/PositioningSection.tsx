...
export function PositioningSection() {
  return (
    <section aria-label="Klone positioning" className="relative bg-white">
      <GridLines />
      <LandingContainer className="relative py-[100px] md:py-[130px]">
        <div className="mx-auto max-w-[780px] text-center">
          ...
          <h2 className="text-[44px] font-bold leading-[1.02] tracking-tight text-[#0a0a0a] md:text-[64px]">
            The easiest way to
          ...
          <p className="mx-auto mt-8 max-w-[560px] text-[16px] leading-[1.65] text-[#525252]">
