...
export function PipelineDiagram() {
  return (
    ...
    >
      ...
      <Float delay={0.2}>
        <g>
          <rect x={64} y={96} width={150} height={56} fill="#ffffff" stroke="#d4d4d4" strokeWidth="1" />
          <rect x={64} y={96} width={150} height={5} fill="#aef637" />
          <text x={76} y={122} fontSize="11" fontWeight="600" fontFamily={SANS} fill="#404040">
            “Write me a quarterly
          </text>
          <text x={76} y={137} fontSize="11" fontWeight="600" fontFamily={SANS} fill="#404040">
            business report.”
          </text>
      ...
      <text x={100} y={370} textAnchor="middle" fontSize="11" fontWeight="600" fontFamily={SANS} fill="#525252">
        Your AI assistant
      </text>
      ...
      <Float delay={0.5}>
        <g>
          <rect x={446} y={56} width={172} height={64} fill="#ffffff" stroke="#d4d4d4" strokeWidth="1" />
          {/* mini layout sketch */}
          <rect x={460} y={68} width={40} height={40} fill="#fafafa" stroke="#c9c9c9" strokeWidth="1" strokeDasharray="3 3" />
          <rect x={467} y={75} width={14} height={3} fill="#aef637" />
          <rect x={467} y={83} width={26} height={7} fill="none" stroke="#c9c9c9" strokeWidth="1" strokeDasharray="2 2" />
          <rect x={467} y={94} width={26} height={7} fill="none" stroke="#c9c9c9" strokeWidth="1" strokeDasharray="2 2" />
          <text x={510} y={82} fontSize="11" fontWeight="600" fontFamily={SANS} fill="#404040">
            Pick a template
          </text>
      ...
      {/* ── Klone core ── */}
      <g>
        <rect x={420} y={182} width={160} height={96} fill="#ffffff" stroke="#9a9a9a" strokeWidth="1" />
        <rect x={420} y={182} width={160} height={5} fill="#aef637" />
        <text x={500} y={228} textAnchor="middle" fontSize="16" fontWeight="700" fontFamily={SANS} fill="#0a0a0a">
          Klone
        </text>
      ...
      <Float alt delay={0.7}>
        <g>
          <rect x={432} y={312} width={58} height={74} fill="#eceafd" stroke="#dcd6f6" strokeWidth="1" />
          <DocPage x={444} y={302} width={62} height={82} accent="#aef637" />
        </g>
      </Float>
      <StepBadge cx={432} cy={306} n={3} />
      <Lock x={524} y={330} size={26} />
      <text x={537} y={372} textAnchor="middle" fontSize="10.5" fontWeight="600" fontFamily={SANS} fill="#525252">
        Your documents
      </text>
      ...
      {/* ── Step 4 · Your editor ── */}
      <g>
        <rect x={780} y={168} width={170} height={112} fill="#ffffff" stroke="#9a9a9a" strokeWidth="1" />
        <rect x={780} y={168} width={170} height={5} fill="#aef637" />
        {/* mini canvas with animated selection */}
        <rect x={796} y={188} width={76} height={72} fill="#fafafa" stroke="#e2e2e2" strokeWidth="1" />
        <rect x={806} y={198} width={48} height={6} fill="#aef637" />
        <rect x={806} y={212} width={56} height={3} fill="#e2e2e2" />
        <rect x={806} y={220} width={48} height={3} fill="#e2e2e2" />
        <rect x={806} y={228} width={52} height={3} fill="#e2e2e2" />
        <g>
        ...
        {/* side panel */}
        <rect x={884} y={188} width={52} height={72} fill="#fafafa" stroke="#e2e2e2" strokeWidth="1" />
        <circle cx={894} cy={199} r={3} fill="#aef637" />
        <circle cx={904} cy={199} r={3} fill="#c7bff4" />
        <rect x={890} y={210} width={38} height={3} fill="#e2e2e2" />
        <rect x={890} y={218} width={30} height={3} fill="#e2e2e2" />
        <rect x={890} y={226} width={34} height={3} fill="#e2e2e2" />
      </g>
      <StepBadge cx={780} cy={168} n={4} tone="accent" />
      <text x={865} y={158} textAnchor="middle" fontSize="11" fontWeight="600" fontFamily={SANS} fill="#525252">
        Your editor
      </text>
      ...
      {/* ── Download as PDF ── */}
      <g>
        <rect x={1006} y={96} width={60} height={42} fill="#0a0a0a" />
        <text x={1036} y={122} textAnchor="middle" fontSize="14" fontWeight="700" fontFamily="var(--font-geist-mono), ui-monospace, monospace" fill="#aef637">
          PDF
        </text>
      </g>
      <g>
        <path d="M 1036 148 v 12 m 0 0 l -6 -7 m 6 7 l 6 -7" stroke="#0a0a0a" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <animateTransform
      ...
      <text x={1036} y={184} textAnchor="middle" fontSize="10" fontWeight="600" fontFamily={SANS} fill="#525252">
        Download it
      </text>
...
export function PipelineSection() {
  return (
    <section id="how" aria-label="How Klone works" className="bg-white">
      <LandingContainer className="py-[100px] md:py-[130px]">
              ...
              <li key={tab}>
                <span
                  className={
                    ...
                    (i === 0
                      ? "text-[#0a0a0a]"
                      : "cursor-pointer text-[#8a8a8a] transition-colors duration-150 hover:text-[#0a0a0a]")
                  }
                >
                  {tab}
                </span>
        ...
        <div className="mt-12 border border-[#e5e5e5] bg-[#fcfcfc] p-4 md:p-6">
          <PipelineDiagram />
        </div>

        <div className="mt-12 grid grid-cols-1 gap-y-8 border-t border-[#e5e5e5] pt-10 md:grid-cols-2 md:gap-x-16">
          <div className="max-w-[460px]">
            <h3 className="text-[22px] font-bold tracking-tight text-[#0a0a0a]">
              Works with the AI you use
            </h3>
            <p className="mt-3 text-[14px] leading-[1.65] text-[#525252]">
            ...
            <a
              href="/register"
              className="group mt-5 inline-flex items-center gap-2 text-[14px] font-medium text-[#0a0a0a] hover:text-[#404040] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0a0a0a]"
            >
